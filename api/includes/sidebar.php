<br><br>
<div class="rowt">
	<div class="box box-solid" style="background-color:pink">
...
<div class="rowt">
	<div class='box box-solid' style="background-color:pink">
	  	...
	  	<div class='box-body'>
	    	...
	    	<a class="btn btn-social-icon btn-twitter" href="https://twitter.com/aka1204_ug/"><i class="fa fa-twitter"></i></a>
	    	<a class="btn btn-social-icon btn-linkedin" href = "https://linkedin.com/in/ugaka1204"><i class="fa fa-linkedin"></i></a>
	  	</div>
	</div>
</div>
